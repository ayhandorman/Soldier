export class Soldier {
    ...
    constructor(world) {
        ...
        this.sprite.src = `${world.assetsPath}soldier.png`;
    }
    ...
    render = () => {
        ...
        this.world.context.ellipse(this.world.screenWidth / 2 + 15, this.world.screenHeight / 2 + 19, 16, 8, 0, 0, 2 * Math.PI);
        this.world.context.fill();
        this.world.context.shadowBlur = 0;
        // </render shadow>

        this.world.context.drawImage(this.sprite, Math.floor(this.counter / 6) * 69, this.direction * 96, 69, 96, this.world.screenWidth / 2 - 20, this.world.screenHeight / 2 - 48, 69, 96);
    };		
}